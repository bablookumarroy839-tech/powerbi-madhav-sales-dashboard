...
This project presents an interactive Sales Analytics Dashboard developed using Power BI to analyze sales performance, profitability, customer behavior, and product trends.
